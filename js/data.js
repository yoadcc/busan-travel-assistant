...
const itineraryData = {
  ...
  "day2": [
    ...
    },
    {
      ...
      "timeStart": "20:30",
      "timeEnd": "22:00",
      "title": "晚餐：水邊最高豬肉湯飯 廣安店 (수변최고돼지국밥 광안점) 🍲",
      "desc": "享用釜山豬肉湯飯排名第一名名店！鮮美濃郁無腥味（近廣安海灘）。",
      "address": "부산 수영구 광안로 63",
      "note": "【美食】加入韭菜、蝦醬調味，搭配金黃酥脆的抗生素豬五花，湯頭濃郁令人回味無窮。官網：http://www.xn--299amk01o1njbwar8ud2ne5g.kr/main",
      "mapLinkKakao": "https://map.kakao.com/link/search/부산 수영구 광안로 63",
      "mapLinkNaver": "https://map.naver.com/v5/search/부산 수영구 광안로 63",
      "estimatedCost": 24000,
      "costLabel": "豬肉湯飯晚餐費"
    }
  ],
  ...
  "day4": [
    ...
    },
    {
      ...
      "desc": "轉場回海雲台（計程車約 20-30 分鐘；或備案地鐵：機張市場步行 5 分鐘至機張站 → 搭東海線電鐵(往釜田方向) 4 站至 BEXCO 站(15分) → 轉乘地鐵 2 號線(往海雲台方向) 2 站至海雲台站(4分) → 5 號出口步行約 10 分鐘抵達沙灘），在海雲台沙灘散步吹海風。",
  ...
  "day6": [
    ...
    },
    {
      ...
      "address": "부산광역시 강서구 공항진입로 108 (김해국제공항)",
      "note": "【交通】建議直接搭計程車直達機場最省力；備案地鐵路線：① 廣安站搭地鐵 2 號線(往沙上方向) 15 站至沙上站(約 28 分鐘) → ② 站內步行轉乘釜金輕軌(跟著 Light Rail 指標走，約 5-8 分鐘) → ③ 輕軌沙上站搭往加耶大方向 3 站至機場站(約 7 分鐘)。費用：交通卡約 ₩2,100-2,300。總耗時含走路等車建議預留 60-70 分鐘，行李多請搭計程車！",
      "mapLinkKakao": "https://map.kakao.com/link/search/김해국제공항",
      "mapLinkNaver": "https://map.naver.com/v5/search/김해국제공항",
      "estimatedCost": 32000,
      "costLabel": "機場直達計程車資"
